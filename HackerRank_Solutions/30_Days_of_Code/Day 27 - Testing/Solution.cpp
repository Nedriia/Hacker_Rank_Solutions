...
public:
	static vector<int> get_array() {
		// complete this function
		//has to return an array of size at least 2 with all unique elements
		vector<int> plusgrandque_Deux{ 1,2,3,4,5,6 };
		return plusgrandque_Deux;
	}
...
public:
	static vector<int> get_array() {
		// complete this function
		// has to return an array where there are exactly two different minimums values
		vector<int> different{ 1,2,1 };
		return different;
	}

	static int get_expected_result() {
		// complete this function
		//has to return the expected mini value index for this array
		return 0;
	}
